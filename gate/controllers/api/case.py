...
from gate.controllers.base import Controller, get_case_memcache_key
from gate.common.swob import HTTPBadRequest, HTTPMethodNotAllowed, Request


class CaseController(Controller):
    """WSGI controller for case requests"""
    server_type = 'Case'

    def __init__(self, app, case_name, **kwargs):
        Controller.__init__(self, app)
        self.case_name = unquote(case_name)
